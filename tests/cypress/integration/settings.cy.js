...
describe('Settings Page', function () {
	...
	it('Has Coming Soon', () => {
		cy
			.get('.wppm-app-settings-coming-soon')
			.scrollIntoView()
			.should('be.visible');
	});
	...
	it('Has Comments Settings', () => {
		cy
			.get('.wppm-app-settings-comments')
			.scrollIntoView()
			.should('be.visible');
	});
	...
	it('Comment Settings Work', () => {
		...
		cy.get('[data-id="comments-per-page-select"]')
			...
			.click(); // 10
		cy.wait(100);
		cy.get('.wppm-app-settings-comments')
